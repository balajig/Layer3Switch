...
LD = $(CROSS_COMPILE)ld
LD_FLAGS = -r -m elf_i386
VERSION= 0.1
CFLAGS = $(DEBUG_FLAGS) -Wall -Wsign-compare -Wpointer-arith -Wbad-function-cast -Wwrite-strings -Wmissing-prototypes -Wmissing-declarations -Wchar-subscripts -Wcast-qual -Wpadded -m32
