...
LD_FLAGS = -r
VERSION= 0.1
CFLAGS = $(DEBUG_FLAGS) -Wall -Wsign-compare -Wpointer-arith -Wbad-function-cast -Wwrite-strings -Wmissing-prototypes -Wmissing-declarations -Wchar-subscripts -Wcast-qual -Wpadded -funwind-tables -fasynchronous-unwind-tables
